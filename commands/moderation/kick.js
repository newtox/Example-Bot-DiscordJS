module.exports = {
    ...
    async execute(message, args, client) {
        ...
        if (!bot.hasPermission('KICK_MEMBERS')) return message.channel.send('I do not have the permission to kick someone, make sure I have the proper permissions!');
        if (!author.hasPermission('KICK_MEMBERS')) return message.channel.send('You do not have the required permissions to use this command!');
